...
void k_sys_HaltAndCatchFire(uint32_t exception, ...)
{
    ...
    k_sys_TerminalPrintf("      Something pretty terrible, like an exception or something\n");
    k_sys_TerminalPrintf("      has happened. Probably your fault. Keep your grubby fingers\n");
    k_sys_TerminalPrintf("      to yourself next time.\n");
