...
.global k_util_CopyBytes
k_util_CopyBytes:
    mov edi, dword ptr [esp + 4]
    mov esi, dword ptr [esp + 8]
    mov eax, dword ptr [esp + 12]
    cmp edi, 0
    jz k_util_copybytes_gtfo
    cmp esi, 0
    jz k_util_copybytes_gtfo
    cmp eax, 0
    jz k_util_copybytes_gtfo
    ...
    test ecx, 0x00000003
    jz k_util_copybytes_same_align
    ...
    k_util_copybytes_byte_copy:
    /* copy any trailing bytes */
    mov ecx, eax
    rep movsb

    k_util_copybytes_gtfo:
    ret
